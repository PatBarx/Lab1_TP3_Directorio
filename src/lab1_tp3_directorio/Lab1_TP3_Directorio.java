...
public class Lab1_TP3_Directorio {
   ...
   //*** MENU para probar... Borrar o comentar!!! ***
        ...
        do {
            ...
            switch (op) {
                ...
                case 4: //If para corroborar si existe CIUDAD y mostrar CLientes de la Ciu. 
                    //Else: avisar q esta mal y salir al menu.
                    System.out.print("Busqueda de Clientes por zona\nCiudad: ");
                    String ciu = sc.nextLine();
                    ArrayList<Cliente> cliList = guiaTel.buscarClienteS(ciu);
                    if (cliList.size() > 0) {
                        for (Cliente cliX : cliList) {
                    ...
                    break;
                case 5: //If para corroborar si existe el Numero TEl y mostrar CLiente borrado.. 
                    //Else: avisar q esta mal y salir al menu.
                ...
                case 6:
                    ...
                    break;
                case 0:
                    JOptionPane.showMessageDialog(null, "Gracias por utilizar nuestra guía Telefónica\n-     *GRUPO 10*     -");
                    break;
            }
        } while (op != 0);
    }
